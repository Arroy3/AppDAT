...
public class EditThuNhap extends AppCompatActivity {
    ...
    private BudgetThuNhapDb budgetDb;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_thu_nhap);


        budgetDb = new BudgetThuNhapDb(this);


        // Lấy danh sách icon
        iconList = IconDb.getThuNhapIcon(this); // Lấy danh sách icon từ IconDb
        ...
        adapter1 = new BudgetListAdapter(this, budgetDb.getAllBudgets());
        ...
        saveButton.setOnClickListener(v -> {
            ...
            boolean isUpdated = false;
                ...
                isUpdated = budgetDb.updateBudget(updatedBudget);  // Update trong BudgetThuNhapDb
